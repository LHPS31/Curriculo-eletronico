    ...
    <article className={styles.post}>
      ...
      <div className={styles.content}>
        ...
        <p>Estou no último periodo de formação em desenvolvimento Front-End.
          Logo começarei uma faculdade de analise e desenvolvimento de sistema, procuro oportunidades para ganhar experiencia na area e logo poder me estabelecer e evoluir em areas diferentes com consequentemente com cargos maiores.
        </p>
        
        <h3>Links Repositorio</h3>
        <a href="https://github.com/LHPS31/curriculo-eletronico">Link repositorio</a>
